    ...
    static getLeaders = async (req, res) => {
        try {
            ...
            for (let i of leaders) {
                ...
                let lead = { ...i._doc, "coins": i._doc.coins.totalCoins, "avatar": userProfile };
                leadersList.push(lead);
            }
            res.status(200).json(ApiModel.getApiModel(Enum.status.SUCCESS, "There is our leaders", leadersList));
